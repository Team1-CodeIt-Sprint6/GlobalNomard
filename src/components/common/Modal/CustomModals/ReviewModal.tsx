...
export default function ReviewModal({
  ...
  if (!activityExists) {
    return (
      <div className="review-modal-container">
        <div className="flex h-full w-full flex-col items-center justify-center p-4 pc:h-[616px] pc:w-[432px] pc:p-0 tablet:h-[616px] tablet:w-[432px] tablet:p-0">
  ...
  return (
    <div className="review-modal-container">
      <div className="h-full w-full p-4 pc:h-[616px] pc:w-[432px] pc:p-0 tablet:h-[616px] tablet:w-[432px] tablet:p-0">
        ...
        <div className="mt-[25px] flex h-[560px] flex-col justify-between pc:mt-[35px] pc:h-[535px] tablet:mt-[35px] tablet:h-[535px]">
          ...
          <textarea
            className="h-[270px] w-full resize-none rounded border border-kv-gray-79 p-4 focus:border-2 focus:border-kv-primary-blue focus:outline-none pc:h-[200px] tablet:h-[200px]"
            rows={4}
